            ...
            <div class="col-md-10 mx-auto">
                <div>
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h6><a href="{{ route('employees.index') }}"><i class="isax isax-arrow-left me-2"></i>employees</a></h6>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3">Edit Employee</h5>
                            <form action="{{ route('employees.update', $employee->id) }}" id="editForm" enctype="multipart/form-data">
                                @method('PUT')
                                ...
                                <div class="mb-3">
                                    <div class="d-flex align-items-center">
                                        <div class="avatar avatar-xxl border border-dashed bg-light me-3 flex-shrink-0" id="avatarPreview"> 
                                            @if($employee->image)
                                                <img src="{{ $employee->profile_image }}" alt="Current Image" class="w-100 h-100 object-fit-cover rounded-circle">
                                            @else
                                ...
                                <div class="row gx-3">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="mobile" value="{{ $employee->mobile }}" required>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-lg-6 col-md-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="dob" id="dob" value="{{ $employee->dob }}" data-provider="flatpickr">
                                        </div>
                                    </div>
                                    <div class="col-lg-6 col-md-6">
                                        <div class="mb-3">
                                            <label class="form-label mb-0">Anniversary</label>
                                            <input type="text" class="form-control" name="anniversary" id="anniversary" value="{{ $employee->anniversary }}" data-provider="flatpickr">
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="select form-control" name="countryid" id="countryid">
                                                    ...
                                                    @foreach($countries as $c)
                                                        <option value="{{ $c['id'] }}" {{ $employee->countryid == $c['id'] ? 'selected' : '' }}>
                                                            {{ $c['name'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <select class="select form-control" name="regionid" id="regionid">
                                                    ...
                                                    @foreach($states as $s)
                                                        <option value="{{ $s['id'] }}" {{ $employee->regionid == $s['id'] ? 'selected' : '' }}>
                                                            {{ $s['name'] }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                ...
                                <div class="d-flex align-items-center justify-content-between pt-4 border-top">
                                    <button type="submit" class="btn btn-primary submitBtn">Update Employee</button>
...
$(document).ready(function() {
    ...
    flatpickr("#anniversary", {
        ...
        altFormat: "d M, Y",
        dateFormat: "Y-m-d",
        defaultDate: "{{ $employee->anniversary }}"
    });
    ...
    $('#editForm').on('submit', async function(e) {
        ...
        $.ajax({
            ...
            success: function(response) {
                if (response.success) {
                    showSuccess(response.message || 'Employee updated successfully');
            ...
            error: function(xhr) {
                ...
                if (xhr.responseJSON && xhr.responseJSON.errors) {
                    ...
                    showError('An error occurred while updating employee');
                }
            },
            complete: function() {
