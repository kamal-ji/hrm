                ...
                <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="{{ route('automation-rule.store') }}" id="createForm"
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="lateEntryRules" class="collapse">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label>
                                                            <input type="checkbox" class="late_entry_deduction_checkbox" name="late_entry_deductions[]" value="{{ $item['id'] }}" data-ha-name="late_entry_deductions" data-ha-container="#lateEntryRules" data-ha-callback="toggler"> {{ $item['name'] }}
                                                        </label>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="earlyExitRules" class="collapse">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label>
                                                            <input type="checkbox" class="early_exit_deduction_checkbox" name="early_exit_deductions[]" value="{{ $item['id'] }}" data-ha-name="early_exit_deductions" data-ha-container="#earlyExitRules" data-ha-callback="toggler"> {{ $item['name'] }}
                                                        </label>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="breaksRule" class="collapse">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label>
                                                            <input type="checkbox" class="break_rule_checkbox" name="break_rules[]" value="{{ $item['id'] }}" data-ha-name="break_rules" data-ha-container="#breaksRule" data-ha-callback="toggler"> {{ $item['name'] }}
                                                        </label>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="overtimeRule" class="collapse">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label>
                                                            <input type="checkbox" class="overtime_rule_checkbox" name="overtime_rules[]" value="{{ $item['id'] }}" data-ha-name="overtime_rules" data-ha-container="#overtimeRule" data-ha-callback="toggler"> {{ $item['name'] }}
                                                        </label>
                                        ...
                                        <div class="card">
                                            ...
                                            <div id="earlyOvertimeRule" class="collapse">
                                                <div class="card-body">
                                                    ...
                                                    <div class="mb-3">
                                                        <label>
                                                            <input type="checkbox" class="early_overtime_rule_checkbox" name="early_overtime_rules[]" value="{{ $item['id'] }}" data-ha-name="early_overtime_rules" data-ha-container="#earlyOvertimeRule" data-ha-callback="toggler"> {{ $item['name'] }}
                                                        </label>
...
@push('scripts')
    ...
    <script>
        ...
        function addLateEntryDeductionRule(cx = 1){
            jQuery('#late_entry_deductions_' + cx).append(`
                <div class="row mb-2" xrole="late-entry-deduction-rule-${cx}">
                    ...
                    <div class="col-md-2">
                        ...
                        <input type="number" class="form-control" min="0" step="0.01" name="late_deduction_${cx}_rules_amount[${lateEntryDeductionRule1Count}][]" placeholder="Amount">
                    </div>
                    <div class="col-md-2">
                        <br>
                        ${
        ...
        function addEarlyExitDeductionRule(cx = 1){
            jQuery('#early_exit_deductions_' + cx).append(`
                <div class="row mb-2" xrole="early-exit-deduction-rule-${cx}">
                    ...
                    <div class="col-md-2">
                        <p class="mb-0">Deduction Amount</p>
                        <input type="number" class="form-control" min="0" step="0.01" name="early_exit_deduction_${cx}_rules_amount[${earlyExitDeductionRule1Count}][]" placeholder="Amount">
                    </div>
                    <div class="col-md-2">
                        <br>
                        ${
        ...
        function addBreakRule(cx = 1){
            jQuery('#break_rules_' + cx).append(`
                <div class="row mb-2" xrole="break-rule-${cx}">
                    ...
                    <div class="col-md-2">
                        <p class="mb-0">Deduction Amount</p>
                        <input type="number" class="form-control" min="0" step="0.01" name="break_rule_${cx}_rules_amount[${breakRule1Count}][]" placeholder="Amount">
                    </div>
                    <div class="col-md-2">
                        <br>
                        ${
        ...
        function addOvertimeRule(cx = 1){
            jQuery('#overtime_rules_' + cx).append(`
                <div class="row mb-2" xrole="overtime-rule-${cx}">
                    ...
                    <div class="col-md-2">
                        <p class="mb-0">Deduction Amount</p>
                        <input type="number" class="form-control" min="0" step="0.01" name="overtime_rule_${cx}_rules_amount[${overtimeRule1Count}][]" placeholder="Amount">
                    </div>
                    <div class="col-md-2">
                        <br>
                        ${
        ...
        function addEarlyOvertimeRule(cx = 1){
            jQuery('#early_overtime_rules_' + cx).append(`
                <div class="row mb-2" xrole="early-overtime-rule-${cx}">
                    ...
                    <div class="col-md-2">
                        <p class="mb-0">Deduction Amount</p>
                        <input type="number" class="form-control" min="0" step="0.01" name="early_overtime_rule_${cx}_rules_amount[${earlyOvertimeRule1Count}][]" placeholder="Amount">
                    </div>
                    <div class="col-md-2">
                        <br>
                        ${
