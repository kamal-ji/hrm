            ...
            <div class="col-md-10 mx-auto">
                <div>
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h6><a href="<?php echo e(route('members.index')); ?>"><i class="isax isax-arrow-left me-2"></i>Members</a></h6>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3">Add New Member</h5>
                            <form action="<?php echo e(route('members.store')); ?>" id="createForm" enctype="multipart/form-data">
...
<div class="border-bottom mb-4 pb-3">
    ...
    <?php if(count($sponsors) > 0): ?>
        <?php $__currentLoopData = $sponsors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sponsor): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($sponsor->id); ?>"
                <?php if(isset($defaultSponsorId) && $sponsor->id == $defaultSponsorId): ?> selected <?php endif; ?>>
                <?php echo e($sponsor->first_name); ?> <?php echo e($sponsor->last_name); ?> 
                (<?php echo e($sponsor->member_id ?? 'N/A'); ?>) - <?php echo e($sponsor->mobile); ?>
...
$(document).ready(function() {
    ...
    $('#sponsor_id').on('change', function() {
        ...
        if (sponsorId) {
            ...
            $.ajax({
                url: "<?php echo e(route('members.sponsor.details')); ?>",
                type: 'GET',
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\wamp64\www\hrm\resources\views/backend/members/create.blade.php ENDPATH**/ ?>