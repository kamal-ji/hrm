...
<head>
    ...
    <title>Login | <?php echo e(get('name')); ?></title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="description"
        content="<?php echo e(get('name')); ?>">
    <meta name="keywords"
        content="<?php echo e(get('name')); ?>">
...
<body class="bg-white">
            ...
            <div class="w-100 overflow-hidden position-relative flex-wrap d-block vh-100">
                ...
                <div class="row justify-content-center align-items-center vh-100 overflow-auto flex-wrap ">
                    <div class="col-lg-4 mx-auto">
                        <form action="" class="d-flex justify-content-center align-items-center" id="apiLoginForm">
                            <?php echo csrf_field(); ?>
                            <div class="d-flex flex-column justify-content-lg-center p-4 p-lg-0 pb-0 flex-fill">
                                <div class=" mx-auto mb-5 text-center">
                                    <img src="<?php echo e(asset('storage/' . get('company_logo'))); ?>" width="100" class="img-fluid" alt="<?php echo e(get('name')); ?>">
                                </div>
                                <div class="card border-0 p-lg-3 shadow-lg">
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3">
                                            ...
                                            <div class="text-end">
                                                <a href="<?php echo e(url('forgot-password')); ?>" class="hover-a">Forgot Password</a>
                                            </div>
                                        </div>
                                ...
                                <a href="<?php echo e(route('register')); ?>">Become a Member? Register</a>
                            </div>
                                        </div>
                ...
                .then(function(registration) {
                    return navigator.serviceWorker.ready.then(function() {
                        return messaging.getToken({
                            vapidKey: 'BBfBWLlTAIhxgaL55rfmwjrDEbxQPX0ukl354HLikNTkkebtIzRTq3FoiD26J7cd_nwNuhTLtTLCWRmhCF6Xv7I',
    ...
    $(document).ready(function() {
        ...
        $('#apiLoginForm').on('submit', async function(e) {
            e.preventDefault();
            ...
            $.ajax({
                url: "<?php echo e(route('login.submit')); ?>", // Laravel route helper used in Blade
                method: 'POST',
                headers: {
...
</html><?php /**PATH D:\wamp64\www\hrm\resources\views/auth/admin-login.blade.php ENDPATH**/ ?>