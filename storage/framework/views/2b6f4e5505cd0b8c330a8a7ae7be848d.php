...
<head>
  <!-- Meta Tags -->
    ...
    <title><?php echo e(get('name')); ?> | Forgot Password</title>
...
<body class="bg-white">
                        ...
                        <form action="" class="d-flex justify-content-center align-items-center" id="apiforgotForm">
                            ...
                            <div class="d-flex flex-column justify-content-lg-center p-4 p-lg-0 pb-0 flex-fill">
                                <div class=" mx-auto mb-5 text-center">
                                    <img src="<?php echo e(asset('storage/' . get('company_logo'))); ?>" class="img-fluid" alt="Logo">
                                </div>
    ...
    $('#loginSpinner').removeClass('d-none');
            ...
            $.ajax({
                url: "<?php echo e(route('forgotpassword.submit')); ?>", // Use the route name instead of the URL route('admin.login.submit'),
                method: 'POST',
...
</html><?php /**PATH D:\wamp64\www\hrm\resources\views/auth/admin-forgotpassword.blade.php ENDPATH**/ ?>