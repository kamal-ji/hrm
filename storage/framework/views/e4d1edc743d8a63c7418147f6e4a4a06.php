    ...
    <div class="twocol-mini">
        ...
        <div class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-menu-start">
                ...
                <li>
                    <a href="<?php echo e(route('members.create')); ?>" class="dropdown-item d-flex align-items-center">
    ...
    <div class="sidebar" id="sidebar-two">
        ...
        <div class="sidebar-logo">
            <a href="<?php echo e(route('dashboard')); ?>" class="logo logo-normal">
                <img src="<?php echo e($logo); ?>" alt="Logo" width="50">
            </a>
            ...
            <a href="<?php echo e(route('dashboard')); ?>" class="dark-small">
                <img src="<?php echo e($logo); ?>" alt="Logo" width="50">
            </a>
            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <ul>
                            <li class="submenu">
                                <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('members.*') ? 'active' : ''); ?>">
                                    <i class="isax isax-people"></i><span>Members</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul>
                                    <li><a href="<?php echo e(route('members.create')); ?>" class="<?php echo e(request()->routeIs('members.create') ? 'active' : ''); ?>">Add New Member</a></li>
                                    <li><a href="<?php echo e(route('members.index')); ?>" class="<?php echo e(request()->routeIs('members.index') ? 'active' : ''); ?>">All Members</a></li>
                                    <li><a href="<?php echo e(route('members.active')); ?>" class="<?php echo e(request()->routeIs('members.active') ? 'active' : ''); ?>">Active Members</a></li>
                                    <li><a href="<?php echo e(route('members.inactive')); ?>" class="<?php echo e(request()->routeIs('members.inactive') ? 'active' : ''); ?>">Inactive Members</a></li>
                                    <li><a href="<?php echo e(route('members.pending')); ?>" class="<?php echo e(request()->routeIs('members.pending') ? 'active' : ''); ?>">New Registrations</a></li>
                                </ul>
                            </li>
                    ...
                    <li>
                        <ul>
                            <li class="submenu">
                                <a href="javascript:void(0);" class="<?php echo e(request()->routeIs('employees.*') ? 'active' : ''); ?>">
                                    <i class="isax isax-briefcase"></i><span>Employees</span>
                                    <span class="menu-arrow"></span>
                                </a>
                                <ul>
                                    <li><a href="<?php echo e(route('employees.index')); ?>" class="">All Employees</a></li>
                                    <li><a href="<?php echo e(route('employees.create')); ?>" class="">Add New Employee</a></li>
                                    <li><a href="<?php echo e(route('employees.active')); ?>" class="">Active Employees</a></li>
                                    <li><a href="<?php echo e(route('employees.inactive')); ?>" class="">Inactive Employees</a></li>
                                    <li><a href="<?php echo e(route('members.pending')); ?>" class="">On Leave</a></li>
                                </ul>
                            </li>
...
</div><?php /**PATH D:\wamp64\www\hrm\resources\views/backend/partials/sidebar.blade.php ENDPATH**/ ?>