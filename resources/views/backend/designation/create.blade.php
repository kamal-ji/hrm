            ...
            <div class="col-md-10 mx-auto">
                <div>
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h6><a href="{{ route('designation.index') }}"><i class="isax isax-arrow-left me-2"></i>Designation</a>
                        </h6>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3">Add Designation</h5>
                            <form action="{{ route('designation.store') }}" id="createForm" enctype="multipart/form-data">
