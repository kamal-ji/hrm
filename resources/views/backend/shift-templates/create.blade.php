        ...
        <div class="row">
            <div class="col-md-10 mx-auto">
                <div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3">Add Shift Template</h5>
                            <form action="{{ route('shift-template.store') }}" id="createForm" enctype="multipart/form-data">
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="time" class="form-control" name="fixed_shift_start_time"
                                                        id="fixed_shift_start_time" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="time" class="form-control" name="fixed_shift_end_time"
                                                        id="fixed_shift_end_time" required>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-lg-6 col-md-6">
                                                <div class="mb-2">
                                                    ...
                                                    <input type="time" class="form-control"
                                                        name="fixed_shift_buffer_start" id="fixed_shift_buffer_start">
                                                </div>
                                            </div>
                                            <div class="col-lg-6 col-md-6">
                                                <div class="mb-2">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <label>
                                                    <input type="checkbox" class="form-check-input"
                                                        name="open_shift_show_action_buttons" value="1">
                                                    Show Action Buttons
                                                </label>
                                            </div>
                                        </div>
...
@push('scripts')
    ...
    <script>
        ...
        function addFixedBreakRow() {
            jQuery('[xrole="breaks"]').append(`
                <tr data-role="break_row" data-index="0">
                    <td>
                        <input type="text" class="form-control" name="fixed_shift_breaks[${fixedBreakIndex}][name]" placeholder="Break Name">
                    </td>
                    <td>
                    ...
                    <td>
                        ...
                        <div class="input-group" data-ha-relative="fixed_shift_breaks_${fixedBreakIndex}_type" data-ha-equal="interval">
                            <input type="time" class="form-control" name="fixed_shift_breaks[${fixedBreakIndex}][interval_start]" placeholder="Interval Start">
                            <input type="time" class="form-control" name="fixed_shift_breaks[${fixedBreakIndex}][interval_end]" placeholder="Interval End">
                        </div>
                    </td>
                    <td>
        ...
        function addShiftRow() {
            jQuery('[xrole="shifts"]').append(`
                <tr xrole="shift-row" data-index="${shiftIndex}">
                    <td>
                        <input type="text" class="form-control" name="rotational_shift[${shiftIndex}][name]">
                    </td>
                    <td>
                        <input type="time" class="form-control" name="rotational_shift[${shiftIndex}][start_time]" onchange="calculateShiftDuration(this)">
                    </td>
                    <td>
                        <input type="time" class="form-control" name="rotational_shift[${shiftIndex}][end_time]" onchange="calculateShiftDuration(this)">
                    </td>
                    <td>
                        <div class="input-group">
                    ...
                    <td>
                        <button type="button" class="btn btn-danger remove-break" onclick="removeShiftRow(this)"><i class="fas fa-trash"></i></button>
                    </td>
                </tr>
            `);
