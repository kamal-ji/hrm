            ...
            <div>
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h6>
                        <a href="{{ route('department.index') }}">
                            <i class="isax isax-arrow-left me-2"></i>Department
                        </a>
                    </h6>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="mb-3">Update Department</h5>

                        <form action="{{ route('department.update',$department->id) }}" method="post" id="createForm" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
