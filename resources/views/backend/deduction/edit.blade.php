            ...
            <div>
                ...
                <div class="d-flex align-items-center justify-content-between mb-3">
                    <h6>
                        <a href="{{ route('deduction.index') }}">
                            <i class="isax isax-arrow-left me-2"></i> Deduction
                        </a>
                    </h6>
                </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <h5 class="mb-3">Update Deduction</h5>

                        <form action="{{ route('deduction.update',$deduction->id) }}" method="post" id="createForm" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="name" value="{{ $deduction->name }}">
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control" name="is_active">
                                            <option value="1" {{ $deduction->is_active == 1 ? 'selected' : '' }}>Active</option>
                                            <option value="0" {{ $deduction->is_active == 0 ? 'selected' : '' }}>Inactive</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
