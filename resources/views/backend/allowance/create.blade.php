            ...
            <div class="col-md-10 mx-auto">
                <div>
                    <div class="d-flex align-items-center justify-content-between mb-3">
                        <h6><a href="{{ route('allowance.index') }}"><i class="isax isax-arrow-left me-2"></i>Allowance</a>
                        </h6>
                    </div>
                    <div class="card">
                        <div class="card-body">
                            <h5 class="mb-3">Add Allowance</h5>
                            <form action="{{ route('allowance.store') }}" id="createForm" enctype="multipart/form-data">
                                
                                <div class="row gx-3">
                                    <div class="col-lg-6 col-md-6">
                                        <div class="mb-2">
                                            <label class="form-label">Allowance Name <span class="text-danger ms-1">*</span></label>
