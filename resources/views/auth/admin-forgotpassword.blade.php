...
<head>
    ...
    <meta name="description" content="{{ get('name') }}">
    <meta name="keywords" content="{{ get('name') }}">
                        ...
                        <form action="" class="d-flex justify-content-center align-items-center"
                            ...
                            <div class="d-flex flex-column justify-content-lg-center p-4 p-lg-0 pb-0 flex-fill">
                                <div class=" mx-auto mb-5 text-center">
                                    <img src="{{ asset('storage/' . get('company_logo')) }}" class="img-fluid"
                                        alt="Logo">
                                </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="mb-1 position-relative">
                                            <button type="submit"
                                                ...
                                                id="forgotpassword"><span id="resettext">Reset
